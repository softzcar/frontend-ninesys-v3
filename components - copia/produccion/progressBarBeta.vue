              ...
              <b-modal :size="size" :title="title" :id="modal" hide-footer>
                <b-overlay :show="overlay" spinner-small>
                  <b-container>
                    <b-row>
                      <b-col>
                        <h5>Detalles de productos Lote {{ data.orden }}</h5>
                        <b-table
                          ref="table"
                          responsive
                          small
                    ...
                    <b-row>
                      <b-col>
                        <h5 class="mt-4">
                          Asignación de personal Lote {{ data.orden }}
                        </h5>
                        <b-card no-body>
                          <b-tabs card>
                              ...
                              <b-row>
                                ...
                                >
                                  <ul>
                                    ...
                                    <li>
                                      <strong>Corte:</strong> {{ item.corte }}
                                    </li>
                                    <li>
                                      <strong>Tela:</strong> {{ item.tela }}
                                    </li>
                                    <li>
