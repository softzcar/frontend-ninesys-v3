          ...
          <b-container>
            ...
            <b-row>
              <b-col lg="12" class="mt-4">
                <b-table responsive :fields="campos" :items="form.products">
                  ...
                  <template #cell(cantidad)="data">
                    <b-form-input
                      ...
                      min="0"
                      type="number"
                      @change="updateMonto(form.products[data.index])"
                    ></b-form-input>
                  </template>

                  <template #cell(corte)="data">
                    <b-form-select
                      v-model="form.products[data.index].corte"
                      :options="cortes"
                      @change="updateCorte(form.products[data.index])"
                    ></b-form-select>
                  </template>
                  ...
                  <template #cell(tela)="data">
                    <b-form-select
                      v-model="form.products[data.index].tela"
                      :options="myTelas"
                      @change="updateTela(form.products[data.index])"
                    ></b-form-select>
                  </template>
